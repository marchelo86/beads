    ...
    <script>
        $( document ).ready(function() {
           ...
           var height = $(document).height();
            //alert(height);
            $('.parallax').css('height', height/10 + 'vh');

            $('.active').children('div.spoiler_body').fadeIn(20);
            $('.noactive').children('div.spoiler_body').fadeOut(20);
        });
    </script>
</head>
...
<body class="parallax">
  <div class="parallax__group" >
    ...
    <div class="<?php echo $class; ?> parallax__layer parallax__layer--base">
      <!--<nav id="top">
        <div class="container">
          <!--<?php echo $currency; ?>-->
          <!--<?php echo $language; ?>-->
      <!--<div id="top-links" class="nav pull-left">
        <ul class="list-inline right_menu">
          ...
          <li>
            <a href="http://beads/index.php?route=information/information&information_id=7">Контакты</a>
          </li>
          <li>
          ...
          <div class="row">
            <div class="col-sm-4_logo">
              ...
              <div class="phone_head">
                  <h2 style="font-size: 400%;"> +380 44 332 64 08 </h2>
      ...
      <a class="heder basket" href="<?php echo $shopping_cart; ?>" title="<?php echo $text_shopping_cart; ?>"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_shopping_cart; ?></span></a>
