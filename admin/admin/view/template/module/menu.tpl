          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
            	<td class="left"><select name="menu_module[<?php echo $module_row; ?>][menu_id]">
                  ...
                  <option value="<?php echo $menu['menu_id']; ?>" selected="selected"><?php echo $menu['menu_name']; ?></option>
                  <?php } else { ?>
...
function addModule() {	
	...
	<?php foreach ($menus as $menu) { ?>
	html += '      <option value="<?php echo $menu['menu_id']; ?>"><?php echo addslashes($menu['menu_name']); ?></option>';
	<?php } ?>
	html += '    </select></td>';
	...
	html += '    </select></td>';
	//html += '    <td class="left"><input type="text" name="menu_module[' + module_row + '][name]" value="" size="30" /></td>';
