        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php echo $column_menuitems; ?></td>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($menu['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $menu['menu_name']; ?></td>
              <td class="left">
              	<?php echo $menu['menu_items']?>
              	<span>[<?php echo $menu['menuitem_link_add']?>]</span>
              	<span>[<?php echo $menu['menuitem_link_view']?>]</span>
              </td>
              <td class="left">
